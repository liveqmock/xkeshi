...
<@m.page_header title="添加商户会员" css='add_seller_new|seller_info|member_validate' selected="member" subselected='list' js="validate|My97DatePicker/WdatePicker" />
<script>
  var MOBILE ;
</script>
<div class="rwrap">
	...
	<a class="back_a" href="<@shiro.hasAnyRoles name="ROLE_MERCHANT_ADMIN">${base}/member/merchant/list</@shiro.hasAnyRoles>
							<@shiro.hasAnyRoles name="ROLE_SHOP_ADMIN">${base}/member/shop/list</@shiro.hasAnyRoles>" title="返回"></a>添加商户会员</div>
	<div class="tb_wrap">
	<div class="tb_title">会员资料</div>
	<form action="${base}/member/merchant/${(shop.eid)!}/add" method="post" class="memberFrom check_form">
		...
		<table class="tb_main">
			...
			<#list (memberTypes[0].memberAttributeTemplate.memberAttributeList)! as key>
				...
				<tr <#if key_index%2==1>class="tr_bg"</#if>>
					<td class="ltd"><em><#if key.required>*</#if></em><span class="td_key">${key.name}</span><span class="td_val">
