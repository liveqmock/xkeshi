...
<@m.page_header title="添加会员" css='add_seller_new|seller_info|member_validate' selected="member" subselected='list' js="validate|My97DatePicker/WdatePicker" />
<script>
  var MOBILE ;
</script>
<div class="rwrap">
	...
	<form action="${base}/member/merchant/add" method="post" class="memberFrom check_form">
		...
		<table class="tb_main">
			<tr>
				<td class="ltd"><em>*</em>
					...
					<span class="td_val">
						<input type="text" class="input-l isneed" data-hint="姓名" name="name" data-maxlen="100">
						<label class="required_error"></label>
					</span>
				</td>
			</tr>
			<tr>
				<td class="ltd"><em style="margin-left:0px;"></em>
					<span class="td_key">昵称</span>
					<span class="td_val">
						<input type="text" class="input-l" name="nickName" data-hint="昵称" data-maxlen="100">
					</span>
				</td>
			</tr>
			<tr class="tr_bg">
			...
			<tr class="tr_bg">
				...
				<span class="td_key">性别</span>
					<span class="td_val">
						<input type="radio" id="sex_rd1" name="gender" class="input-l isneed sex_rd" data-hint="性别" value="male"/><label for="sex_rd1" class="lb_rd_on">先生</label>
						<input type="radio" id="sex_rd2" name="gender" class="input-l isneed sex_rd" data-hint="性别" value="female"/><label for="sex_rd2" class="lb_rd">女士</label>
						<label  class="required_error"></label>
					</span>
				</td>
			</tr>
				...
				<tr <#if key_index%2==1>class="tr_bg"</#if>>
					...
					<span class="td_val">
						...
						<#elseif key.attributeType == 'checkbox'>
							<div style="width:700px;margin-left:115px;display:inline-block;margin-top:-20px;">
