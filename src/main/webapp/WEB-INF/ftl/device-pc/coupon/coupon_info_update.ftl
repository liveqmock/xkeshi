...
<#if couponInfoType == 'NORMAL'>
	<@m.page_header title="编辑 电子券" selected='coupon' subselected='couponInfoList' css="add_seller_new|seller_info" js="My97DatePicker/WdatePicker|coupon_new"/>
<#else>
	<@m.page_header title="编辑 套票" selected='coupon' subselected='couponInfoPackageList' css="add_seller_new|seller_info" js="My97DatePicker/WdatePicker|coupon_new"/>
</#if>
<script>
...
<div class="rwrap">
	...
	<form action="${base}/coupon/process_update" method="POST" enctype="multipart/form-data">
	<div class="tb_wrap">
		...
		<table class="tb_main">
			<tr>
				<td class="ltd" colspan='2'><em>*</em><span class="td_key">名称</span><span class="td_val"><input name="name" id="name" class="ip1 ckhed" type="text" value="${(couponInfo.name)!}"></span></td>
			</tr>
			<tr class="tr_bg">
				<td class="ltd" colspan='2'><em>*</em><span class="td_key">简介</span><span class="td_val"><textarea class="td_text" class="ckhed"  name="intro" id="intro">${(couponInfo.intro)!}</textarea></span></td>
			</tr>
			<tr>
				<td class="std" style="vertical-align:top;"><em>*</em><span class="td_key">详情页大图</span><span class="td_val"><input type="file" name="picFile" id="picFile" class="file_ip ckhed" onchange='checkPhoto(this.value);' oninput='checkPhoto(this.value);' /></span>
				<#if (couponInfo.pic)??>
					<img src="${image_base}/${couponInfo.pic}" style="width:300px;margin-top:20px;margin-left:104px;"/>
				</#if>
				</td>
				<td class="std" style="vertical-align:top;"><em class="v9">*</em><span class="td_key">列表用缩略图</span><span class="td_val"><input type="file" name="thumbFile" id="thumbFile" class="file_ip v9 ckhed" onchange='checkPhoto(this.value);' oninput='checkPhoto(this.value);' /></span>
				<#if (couponInfo.thumb)??>
			...
			<tr class="tr_bg">
				<td><em>*</em><span class="td_key">有效期</span><span class="td_val"><input type="text" name="startDate" id="startDate" class="ckhed" value="${(couponInfo.startDate?string("yyyy-MM-dd HH:mm:ss"))!}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" /> - <input type="text" name="endDate" id="endDate" class="ckhed" value="${(couponInfo.endDate?string("yyyy-MM-dd HH:mm:ss"))!}"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" /></span></td>
				<td><em>&nbsp;</em><span class="td_key">服务保障</span>
					<span class="td_val">
			...
			<tr>
				<td class="std" colspan='2'><em>*</em><span class="td_key">描述详情</span><script id="description" name="description" type="text/plain" style="width:855px;height:300px;">${(couponInfo.description)!}</script></td>
			</tr>
			<tr class="tr_bg">
	...
	<div class="tb_wrap">
		<table class="tb_main">
			...
			<tr>
				<td><em style="margin-left:6px;"></em><span class="td_key">售价</span><span class="td_val"><input type=“text" id="price" name="price" value="${(couponInfo.price)!}"  onpropertychange='check(this.value)' oninput='check(this.value)' class="short" />&nbsp;&nbsp;&nbsp;元</span></td>
				<td>
				<#if couponInfoType == 'NORMAL'>
					<em style="margin-left:6px;"></em><span class="td_key">原价</span><span class="td_val"><input type=“text" id="originalPrice" name="originalPrice" value="${(couponInfo.originalPrice)!}" onpropertychange='check(this.value)' oninput='check(this.value)'  class="short" />&nbsp;&nbsp;&nbsp;元</span>
				</#if>
				</td>
			</tr>
			<tr class="tr_bg">
			...
			<tr>
				<td class="ltd" colspan='2'><em style="margin-left:6px;"></em><span class="td_key">支付超时</span><span class="td_val">拍下
