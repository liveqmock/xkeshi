...
<@m.page_header selected='order' subselected = "item" css="admin_frame|chart_page|merchant_analyse" js ="My97DatePicker/WdatePicker|highcharts|analyse|product_analyse" title='商品分析'/>
<script>
	DATE1="${startDate}"
	DATE2="${endDate}"
	DAY_BLOCK="${dayBlock}"
...
width: 100%;
	...
	<div class="rwrap">
		<div class="r_title"><span class="fl">商品分析</span><div class="search_wrap"></div></div>
		<div class="top_sel_wrap top_zdex">
			...
			<div class="selex_wrap selex_wrap2">
				<div class="selex_head">销量</div>
				<div class="selex_main">
					<#list itemRatioTypes as type>
		...
		<div class="chart_wrap">
			<div class="chart_nav">
				...
				<a class="chart_nav_a chart_nav_now" href="javascript:">热销商品</a>
			</div>
			<div class="chart_main">
				...
				<div class="chart_r" style="padding-left:0;width:273px;">
					<table class="chart_rtb" style="width:244px;margin:0 auto;"></table>
				</div>
			</div>
		</div>
