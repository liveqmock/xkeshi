...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        //,imageUrl:'http://v0.api.upyun.com/xpos-img-test'             //图片上传提交地址
        //,imagePath:"http://xpos-img-test.b0.upaiyun.com/"                    //图片访问地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imageUrl:'http://v0.api.upyun.com/'+IMG_BUCKET             //图片上传提交地址
        ,imagePath:IMG_PATH                    //图片访问地址，引用了fixedImagePath,如有特殊需求，可自行配置        	
