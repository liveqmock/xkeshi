	 ...
	 $('.opt1').click(function(){
		 if( $("input[name='merchantIds']:checked").length == 0){
			 var self = $('.opt1'),
				...
				pop;
				pop = $('.pb_warn');
				pop.css({'top':top+50, 'left':left-200+self.width()}).show();
			 return false;
		  }
	 ...
	 $('.opt2').click(function(){
		 if( $("input[name='merchantIds']:checked").length == 0){
			 var self = $('.opt2'),
				...
				pop;
				pop = $('.pb_warn');
				pop.css({'top':top+50, 'left':left-220+self.width()}).show();
			 return false;
		  }
	...
	//修改
	 ...
	 $('.opt3').click(function(){
		    ...
		    if( ts.length == 1){
				...
				pop;
				pop = $('.pb_warn');
				pop.css({'top':top+50, 'left':left-240+self.width()}).show();
		    }
		});
	 //删除
	$('.opt4').click(function(){ 
		 if( $("input[name='merchantIds']:checked").length == 0){
			 var self = $('.opt4'),
				...
				pop;
				pop = $('.pb_warn');
				pop.css({'top':top+50, 'left':left-260+self.width()}).show();
			 return false;
		  } else {
	...
	$(".pb_btn_merchant").click(function(){
		...
		if(username == $('#username').val().trim()){
			...
			$.ajax({
				   ...
				   async: false,
				   dataType :'json',
				   url: "/merchant/account/"+$('#username').val().trim(),
