...
import net.sudaibang.common.utils.Reflections;
...
public abstract class BaseInterceptor implements Interceptor, Serializable {
     ...
     */
    protected static Query convertParameter(Object parameterObject, Query queryVO) throws NoSuchFieldException {
        if (parameterObject instanceof Page) {
            queryVO = (Query) parameterObject;
        } 
        return queryVO;
    }
